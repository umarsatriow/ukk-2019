...
<head>
    ...
    <title>CLIENT PPOB</title>
    <!-- Favicon-->
      <!-- <link rel="icon" href="<?=base_url()?>assets/images/image-gallery/thumb/thumb-6.jpg" type="image/x-icon"> -->
...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">PELANGGAN</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?=base_url('index.php/logout_user')?>"><i class="glyphicon glyphicon-off" style="padding-right: 10px"></i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                ?>
                    ...
                    <li <?=@$trans?>>
                        <a href="<?=base_url('index.php/trans')?>">
                            <i class="glyphicon glyphicon-list-alt" style="padding-top: 8px"></i>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2019 - 2020 <a href="javascript:void(0);">SMK TELKOM MALANG</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
